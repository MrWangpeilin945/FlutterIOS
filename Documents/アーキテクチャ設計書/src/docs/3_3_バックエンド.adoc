...
image::../images/BackendLayer.drawio.svg[バックエンドレイヤー]
...
image::../images/BackendCustomException.drawio.svg[カスタム例外]
...
image::../images/BackendDevFlow.drawio.svg[バックエンド開発フロー]
...
WebAPI仕様書に記載したリクエストおよびレスポンスのJSON文字列をC#のClassに変換する必要がある。
