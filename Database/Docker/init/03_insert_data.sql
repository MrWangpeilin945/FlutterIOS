...
-- 検査結果出力履歴
INSERT INTO resultcollector.export_histories(place_schedule_id,exported_at,exported_by,created_at,created_by) VALUES 
    (2,TIMESTAMP '2024-11-25 12:57:15.506','職員B',CURRENT_TIMESTAMP,'init')
  , (3,TIMESTAMP '2024-10-22 20:00:00.000','職員A',CURRENT_TIMESTAMP,'init')
  , (1,TIMESTAMP '2024-10-03 13:20:00.000','職員B',CURRENT_TIMESTAMP,'init')
  , (1,TIMESTAMP '2023-02-25 09:24:000.000','職員A',CURRENT_TIMESTAMP,'init');
