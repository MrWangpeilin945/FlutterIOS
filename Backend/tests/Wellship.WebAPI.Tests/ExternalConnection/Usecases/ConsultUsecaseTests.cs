...
public class ConsultUsecaseTests
{
    ...
    [Fact]
    public async Task 空値のチェック_連携キー()
    {
        // Arrange
        // 会場コードに紐づく会場IDを取得する
        ...
        {
            new Consult {
                    SortNo= 1, ConnectionCode = "", ActionType = 0, PlaceCode = "P001",TeamCode = "T001", ExamDate = "2024-10-02",
    ...
    public async Task 空値のチェック_会場コード()
    {
        ...
        {
            new Consult {
                    SortNo= 1, ConnectionCode = "C001", ActionType = 0, PlaceCode = "",TeamCode = "T001", ExamDate = "2024-10-02",
    ...
    public async Task 空値のチェック_班コード()
    {
        ...
        {
            new Consult {
                    SortNo= 1, ConnectionCode = "C001", ActionType = 0, PlaceCode = "P001",TeamCode = "", ExamDate = "2024-10-02",
    ...
    public async Task 空値のチェック_受診番号()
    {
        ...
        {
            new Consult {
                    SortNo= 1, ConnectionCode = "C001", ActionType = 0, PlaceCode = "P001",TeamCode = "T001", ExamDate = "2024-10-02",
    ...
    public async Task 重複キーのチェック_処理順()
    {
        ...
        var request = new List<Consult>
        {
            ...
            new Consult {
                    SortNo= 1, ConnectionCode = "C001", ActionType = 0, PlaceCode = "P001",TeamCode = "T001", ExamDate = "2024-10-12",
                    ConsultNumber = "N001", ExamineeCd = "E001", Note = "処理順が重複",
                    PreviousResults = [], ConsultThresholds = [], ConsultNotes = [], ExamItemDetailOrders = [],
                    InputNote = "UT2004-02"
                }
    ...
    public async Task 文字数のチェック_受診番号()
    {
        ...
        var request = new List<Consult>
        {
            new Consult {
                    SortNo= 1, ConnectionCode = "C001", ActionType = 0, PlaceCode = "P001",TeamCode = "T001", ExamDate = "2024-10-02",
                    ConsultNumber = "12345678901234567890123456789012345678901234567890a", ExamineeCd = "E001", Note = "受診番号が文字数超",
                    PreviousResults = [], ConsultThresholds = [], ConsultNotes = [], ExamItemDetailOrders = [],
                    InputNote = "UT2004"
                }
        };
    ...
    public async Task 文字制限のチェック_受診番号()
    {
        ...
        var request = new List<Consult>
        {
            new Consult {
                    SortNo= 1, ConnectionCode = "C001", ActionType = 0, PlaceCode = "P001",TeamCode = "T001", ExamDate = "2024-10-02",
                    ConsultNumber = "123-456$_a#123-456$_a#", ExamineeCd = "E001", Note = "受診番号の形式が無効",
                    PreviousResults = [], ConsultThresholds = [], ConsultNotes = [], ExamItemDetailOrders = [],
                    InputNote = "UT2004"
                }
        };
    ...
    public async Task 連携キーのチェック_受診番号()
    {
        ...
        var request = new List<Consult>
        {
            new Consult {
                    SortNo= 1, ConnectionCode = "C001", ActionType = 0, PlaceCode = "P001",TeamCode = "T001", ExamDate = "2024-10-02",
                    ConsultNumber = "N001", ExamineeCd = "E001", Note = "連携キーのチェック",
                    PreviousResults = [], ConsultThresholds = [], ConsultNotes = [], ExamItemDetailOrders = [],
                    InputNote = "UT2004"
                }
        };
