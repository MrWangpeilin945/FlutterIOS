...
public class AbsoluteGreaterThanTest
{
    [Fact]
    public void 入力値の差の絶対値が判定値より大きい_対象()
    {
        // Arrange
        var inputValues = new List<string> { "120.1", "100" };
        var conditionValues = new List<string> { "20" };
        var ruleTriggerType = RuleTriggerType.AbsoluteGreaterThan;
    ...
    [Fact]
    public void 入力値の差の絶対値が判定値と等しい_対象外()
    {
        // Arrange
    ...
    [Fact]
    public void 入力値の差の絶対値が判定値未満_対象外()
    {
        // Arrange
