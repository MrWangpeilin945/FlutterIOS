...
public class NumericInputGreaterThanOrEqualTest
{
    [Fact]
    public void 入力1が入力2以上_対象()
    {
        // Arrange
        var inputValues = new List<string> { "200.75", "100.50" };
        var ruleTriggerType = RuleTriggerType.NumericInputGreaterThanOrEqual;
