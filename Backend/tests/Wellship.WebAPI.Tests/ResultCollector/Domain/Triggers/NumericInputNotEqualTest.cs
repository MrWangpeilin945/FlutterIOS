...
public class NumericInputNotEqualTest
{
    [Fact]
    public void 入力値が異なる_対象()
    {
        // Arrange
        var inputValues = new List<string> { "200.5", "200.4" };
        var ruleTriggerType = RuleTriggerType.NumericInputNotEqual;
