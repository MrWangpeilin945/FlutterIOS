...
public class NumericConditionGreaterThanOrEqualTest
{
    [Fact]
    public void 入力1が判定1以上_対象()
    {
        // Arrange
        var inputValues = new List<string> { "200.75" };
        var conditionValues = new List<string> { "100.50" };
        var ruleTriggerType = RuleTriggerType.NumericConditionGreaterThanOrEqual;
