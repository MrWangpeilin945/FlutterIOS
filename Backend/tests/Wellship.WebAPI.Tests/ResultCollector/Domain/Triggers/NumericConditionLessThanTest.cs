...
public class NumericConditionLessThanTest
{
    [Fact]
    public void 入力1が判定1未満_対象()
    {
        // Arrange
        var inputValues = new List<string> { "100.50" };
        var conditionValues = new List<string> { "200.75" };
        var ruleTriggerType = RuleTriggerType.NumericConditionLessThan;
