...
public class NumericConditionLessThanOrEqualTest
{
    [Fact]
    public void 入力1が判定1以下_対象()
    {
        // Arrange
        var inputValues = new List<string> { "100.50" };
        var conditionValues = new List<string> { "200.75" };
        var ruleTriggerType = RuleTriggerType.NumericConditionLessThanOrEqual;
