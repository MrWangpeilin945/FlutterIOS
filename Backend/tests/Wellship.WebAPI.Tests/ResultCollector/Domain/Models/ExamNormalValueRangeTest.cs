...
public class ExamNormalValueRangeTests
{
    ...
    [
        [new ExamNormalValueRange() {
            Name = "20歳以上40歳未満", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "200000", MaxAge = "400000", 
        ...
        [new ExamNormalValueRange() {
            Name = "41歳以上75歳以下", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "410000", MaxAge = "750001", 
            TargetSex = TargetSex.両方, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, new Age { Years = 75, Months = 0, Days = 0 }, true],         //75歳0ヶ月0日
        [new ExamNormalValueRange() {
            Name = "40歳未満", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "00000", MaxAge = "400000", 
            TargetSex = TargetSex.両方, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, new Age { Years = 40, Months = 0, Days = 0 }, false],        //40歳0ヶ月0日
        [new ExamNormalValueRange() {
            Name = "40歳未満", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "00000", MaxAge = "400000", 
        ...
        [new ExamNormalValueRange() {
            Name = "年齢制限なし", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "00000", MaxAge = "9999999", 
            TargetSex = TargetSex.両方, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        ...
        [new ExamNormalValueRange() {
            Name = "39歳以上42歳未満", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "390000", MaxAge = "420000", 
            TargetSex = TargetSex.両方, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, new Age { Years = 42, Months = 0, Days = 0 }, false],        //42歳0ヶ月0日
        [new ExamNormalValueRange() {
            Name = "39歳以上42歳以下", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "390000", MaxAge = "420001", 
            TargetSex = TargetSex.両方, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
    ...
    [
        [new ExamNormalValueRange() {
            Name = "両方:男性", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "200000", MaxAge = "400000", 
            TargetSex = TargetSex.両方, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, Sex.男, true],
        [new ExamNormalValueRange() {
            Name = "両方:女性", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "200000", MaxAge = "400000", 
            TargetSex = TargetSex.両方, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, Sex.女, true],
        [new ExamNormalValueRange() {
            Name = "男性:男性", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "200000", MaxAge = "400000", 
            TargetSex = TargetSex.男, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, Sex.男, true],
        [new ExamNormalValueRange() {
            Name = "男性:女性", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "200000", MaxAge = "400000", 
            TargetSex = TargetSex.男, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, Sex.女, false],
        [new ExamNormalValueRange() {
            Name = "女性:男性", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "200000", MaxAge = "400000", 
            TargetSex = TargetSex.女, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, Sex.男, false],
        [new ExamNormalValueRange() {
            Name = "女性:女性", ThresholdId = 1, ExamItemDetailId = 1, MinAge = "200000", MaxAge = "400000", 
            TargetSex = TargetSex.女, MaxValue = 999, MinValue = 0, ErrorLevel = InputErrorLevel.正常, Priority = 1
        }, Sex.女, true],
    ];
