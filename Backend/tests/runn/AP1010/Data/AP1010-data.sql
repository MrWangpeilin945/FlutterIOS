...
insert into resultcollector.examinees(examinee_id, examinee_code, name, kana_name, sex, birthdate, created_at, created_by)
    values('e0001010-0000-0000-0000-000000000001', '10101', '同姓　香', 'ドウセイ　カオル', 1, '1991-01-30', CURRENT_TIMESTAMP,'ap1010')
    ,     ('e0001010-0000-0000-0000-000000000002', '10102', '同姓　香織', 'ドウセイ　カオル', 2, '1989-03-15', CURRENT_TIMESTAMP,'ap1010')
    ,     ('e0001010-0000-0000-0000-000000000003', '10103', '同姓　薫', 'ドウセイ　カヲル', 2, '1989-03-15', CURRENT_TIMESTAMP,'ap1010')
    ,     ('e0001010-0000-0000-0000-000000000004', '10104', '同姓　由紀', 'ドウセイ　ユキ', 2, '1972-04-24', CURRENT_TIMESTAMP,'ap1010')
    ,     ('e0001010-0000-0000-0000-000000000005', '10105', '同姓　由紀', 'ドウセイ　ヨシノリ', 1, '1968-12-24', CURRENT_TIMESTAMP,'ap1010');
-- 受診を登録する
insert into resultcollector.consult(consult_id, consult_number, progress_status, export_status, place_schedule_id, note, examinee_id, external_connection_code, created_at, created_by)
    ...
    ,     ('a0101000-0000-0000-0000-000000000004', '10104', 11, 11, '00001010-0000-0000-0000-000000000001','','e0001010-0000-0000-0000-000000000004','10144', CURRENT_TIMESTAMP,'ap1014')
    ,     ('a0101000-0000-0000-0000-000000000005', '10105', 11, 11, '00001010-0000-0000-0000-000000000001','','e0001010-0000-0000-0000-000000000005','10145', CURRENT_TIMESTAMP,'ap1014');
