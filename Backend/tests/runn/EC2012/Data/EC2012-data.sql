...
insert into resultcollector.teams (team_id, team_code, name, order_number, created_at, created_by)
    ...
    ,     ('c0002012-0000-0000-0000-000000000005', 'T2012-05', 'Ⅴ班', 5, CURRENT_TIMESTAMP, 'ec2012')
    ,     ('c0002012-0000-0000-0000-000000000006', 'T2012-06', 'Ⅵ班', 6, CURRENT_TIMESTAMP, 'ec2012');
-- 会場
insert into resultcollector.places (place_id, place_code, name, order_number, created_at, created_by)
    ...
    ,     ('e0002012-0000-0000-0000-000000000005', 'P2012-05', '第Ⅴ会場', 5, CURRENT_TIMESTAMP, 'ec2012')
    ,     ('e0002012-0000-0000-0000-000000000006', 'P2012-06', '第Ⅵ会場', 6, CURRENT_TIMESTAMP, 'ec2012');
-- 会場日程
