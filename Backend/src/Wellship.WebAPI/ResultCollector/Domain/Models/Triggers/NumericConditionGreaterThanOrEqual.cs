...
/// 入力1が判定1以上か
/// </summary>
public sealed class NumericConditionGreaterThanOrEqual : TriggerBase
{
    ...
    /// コンストラクタ
    /// </summary>
    public NumericConditionGreaterThanOrEqual(List<string> inputValues, List<string> conditionValues, InputErrorLevel errorLevel)
    {
