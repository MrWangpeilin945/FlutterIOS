...
/// 入力1が判定1より大きいか
/// </summary>
public sealed class NumericConditionGreaterThan : TriggerBase
{
    ...
    /// コンストラクタ
    /// </summary>
    public NumericConditionGreaterThan(List<string> inputValues, List<string> conditionValues, InputErrorLevel errorLevel)
    {
