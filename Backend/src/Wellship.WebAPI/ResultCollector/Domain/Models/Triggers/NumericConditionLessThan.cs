...
/// 入力1が判定1未満か
/// </summary>
public sealed class NumericConditionLessThan : TriggerBase
{
    ...
    /// コンストラクタ
    /// </summary>
    public NumericConditionLessThan(List<string> inputValues, List<string> conditionValues, InputErrorLevel errorLevel)
    {
