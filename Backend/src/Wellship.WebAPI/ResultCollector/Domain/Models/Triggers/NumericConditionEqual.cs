...
/// 入力1と判定1が等しい数値か
/// </summary>
public sealed class NumericConditionEqual : TriggerBase
{
    ...
    /// コンストラクタ
    /// </summary>
    public NumericConditionEqual(List<string> inputValues, List<string> conditionValues, InputErrorLevel errorLevel)
    {
