...
/// 入力値の差の絶対値が判定値以下か
/// </summary>
public sealed class AbsoluteLessThanOrEqual : TriggerBase
{
    ...
    /// コンストラクタ
    /// </summary>
    public AbsoluteLessThanOrEqual(List<string> inputValues, List<string> conditionValues, InputErrorLevel errorLevel)
    {
