...
/// 入力値の差の絶対値が判定値より大きいか
/// </summary>
public sealed class AbsoluteGreaterThan : TriggerBase
{
    ...
    /// コンストラクタ
    /// </summary>
    public AbsoluteGreaterThan(List<string> inputValues, List<string> conditionValues, InputErrorLevel errorLevel)
    {
