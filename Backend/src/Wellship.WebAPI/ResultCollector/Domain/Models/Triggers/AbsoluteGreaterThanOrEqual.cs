...
/// 入力値の差の絶対値が判定値以上か
/// </summary>
public sealed class AbsoluteGreaterThanOrEqual : TriggerBase
{
    ...
    /// コンストラクタ
    /// </summary>
    public AbsoluteGreaterThanOrEqual(List<string> inputValues, List<string> conditionValues, InputErrorLevel errorLevel)
    {
