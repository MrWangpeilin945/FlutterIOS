...
namespace Ryobi.Wellship.WebAPI.ExternalConnection.Usecases
{
    ...
    /// EC2001_受診者を登録する
    /// </summary>
    public class ExamineeUsecases : IExamineeUsecases
    {
        ...
        public ExamineeUsecases(IDbConnectionProvider dbConnectionProvider, IOrganizationRepository organizationRepository, IExamineeRepository examineeRepository, IAffiliationRepository affiliationRepository)
        {
